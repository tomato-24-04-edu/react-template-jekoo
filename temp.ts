...
export const fuseSettingsSlice = createSlice({
  ...
  selectors: {
    ...
    selectFuseCurrentLayoutConfig: (fuseSettings) =>
      fuseSettings.current.layout.config,
    selectFuseDefaultSettings: (fuseSettings) => fuseSettings.defaults,
    selectCustomScrollbarsEnabled: (fuseSettings) =>
      fuseSettings.current.customScrollbars,
  },
});
